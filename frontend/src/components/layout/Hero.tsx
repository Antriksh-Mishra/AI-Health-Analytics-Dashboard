      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-16 items-center">
        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col sm:flex-row gap-4 pt-4">
            <Button variant="primary" size="lg" rightIcon={<ArrowRight size={18} />} onClick={() => navigate("/register")}>
              Get Started Free
            </Button>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="rounded-2xl border border-slate-100 bg-white p-4 shadow-sm dark:border-slate-800/60 dark:bg-slate-950/40">
                ...
                <div className="flex items-baseline gap-2">
                  <span className="text-4xl font-extrabold font-mono text-slate-800 dark:text-white">84</span>
                  <span className="text-sm font-semibold text-green-500 font-mono">+4% (Good)</span>
                </div>
              ...
              <div className="md:col-span-2 rounded-2xl bg-blue-50/30 p-4 dark:border-blue-900/10 dark:bg-blue-950/10 text-left">
